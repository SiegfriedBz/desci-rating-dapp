    ...
    <main className="flex flex-1 flex-col">
      ...
      >
        <div className="relative mx-auto w-full max-w-6xl px-4 sm:px-6">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-muted">
            Publication KAs in the system context graph, with scores and R-KA
            identifiers when they exist on-chain in the DKG.
          </p>
          <div className="mt-10">
      ...
      >
        <div className="relative mx-auto w-full max-w-6xl px-4 sm:px-6">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-muted">
            Publish a new Knowledge Asset from a paper, or request a rating on
            one that already lives on the DKG.
          </p>
        </div>
      </section>
      <FlowPublishKa />
