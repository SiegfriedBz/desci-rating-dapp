...
KAs on OriginTrail DKG are cryptographically proven and queryable, but carry no quality signal. Agents traversing the graph to build hypotheses have no way to weight source reliability.
